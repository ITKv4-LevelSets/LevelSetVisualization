...
int main( int argc, char* argv[] )
{
  ...
  nameGenerator->SetSeriesFormat( "/home/ajg23/Kishore/%d.png" );
  ...
  typedef itk::BinaryImageToWhitakerSparseLevelSetAdaptor< ImageType, LevelSetOutputType >
  ...
  typedef vtkVisualize2DWhitakerLevelSetLayers< ImageType, LevelSetOutputType, Dimension >
      VisualizationType;
